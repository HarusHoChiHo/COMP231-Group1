...
export default function Page() {
    ...
    useEffect(() => {
        try {
            ...
            if (params.id) {
                (async () => {
                    const responseBlog: Blog = await (await (httpService.callAPI(`/api/blogs/${params.id}`, null, "GET", token))).json();
    ...
    const handleCreatePost = () => {
        ...
        httpService.callAPI("/api/blogs", blogData, "POST", token).then(response => {
    ...
    const handleUpdatePost = () => {
        ...
        const blogData: Blog = new Blog(id, title, content, publishDate, authorName);
